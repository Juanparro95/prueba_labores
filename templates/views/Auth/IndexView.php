...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <form action="auth/show" method="post" novalidate>
                ...
                <div class="input-group mb-3">
                    <input type="password" class="form-control" placeholder="Ingrese su contrase&ntilde;a" id="password"
                        name="password">
                    <div class="input-group-append">
                        <div class="input-group-text">
            ...
            <p class="mb-0">
                <a href="auth/register/" class="text-center">Registrarme</a>
            </p>
        </div>
        <!-- /.login-card-body -->
    </div>
